 ...
 * 
 */
@WebServiceClient(name = "CalculatorWS", targetNamespace = "http://wsTest.tn.ru/", wsdlLocation = "http://localhost:8080/WSRS/CalculatorWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWS_QNAME = new QName("http://wsTest.tn.ru/", "CalculatorWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WSRS/CalculatorWS?wsdl");
    ...
    public CalculatorWS getCalculatorWSPort() {
        return super.getPort(new QName("http://wsTest.tn.ru/", "CalculatorWSPort"), CalculatorWS.class);
    }
    ...
    public CalculatorWS getCalculatorWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wsTest.tn.ru/", "CalculatorWSPort"), CalculatorWS.class, features);
    }
